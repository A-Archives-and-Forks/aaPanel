...
`),F())})},F=()=>{P();let e=m.value;e&&C.loadAddon(new b.AttachAddon(e))},I=()=>{l(()=>{if(w.fit(),h.value!==`CLOSED`){let{cols:e,rows:t}=C;g({cols:e,rows:t,resize:1})}})},L=!0,R=new ResizeObserver(()=>{c(()=>{if(L){L=!1;return}I()},200)()}),z=()=>{let e=E.value;e&&R.observe(e)};return t(()=>{D(),z()}),n(()=>{_(),R==null||R.disconnect(),C==null||C.dispose()}),(t,n)=>(r(),e(`div`,{ref_key:`terminalRef`,ref:E,class:`w-full h-full`},null,512))}});o();var w=d(a({__name:`index`,props:{data:{},url:{}},emits:[`success`],setup(a,{expose:o,emit:d}){let{t:p}=u(),m=a,{data:h}=m,g=d,{ws:_,status:C,send:w,open:T,close:E}=f(m.url,{get verifyData(){return{...h}},onMessage:(e,t)=>{let n=t.data;if(n.indexOf(`Authentication timeout.`)>-1)k.value=!0;else if(n==`\\r\\nlogout\\r\\n`||n==`logout\\r\\n`||n==`\r
logout\r
`||n==`logout\r
`||n.search(/logout[\r\n]+$/)>-1){D.write(`\r`+p(`Component.Terminal.index_1`)+`\r`),L(),E();return}}}),D,O,k=i(!1),A=i(null),j=()=>{D=new v.Terminal({cursorBlink:!0,fontSize:14,fontFamily:`Monaco, Menlo, Consolas, 'Courier New', monospace`,theme:{background:`#333`,foreground:`#ececec`}}),O=new y.FitAddon,N(),P(),R(),B()},M=null,N=()=>{let e=_.value;e&&(D.loadAddon(O),D.loadAddon(new S.CanvasAddon),D.loadAddon(new x.WebLinksAddon),M=new b.AttachAddon(e),D.loadAddon(M),setTimeout(()=>{O.fit()},100))};s([_,C],([e,t])=>{if(t===`CLOSED`&&e){D.write(`\r
`+p(`Component.Terminal.index_2`)+`\r
...
`+p(`Component.Terminal.index_2`)+`\r
`),z())})},z=()=>{T(),R();let e=_.value;e&&D.loadAddon(new b.AttachAddon(e))},B=()=>{l(()=>{if(O.fit(),C.value!==`CLOSED`){let{cols:e,rows:t}=D;w({cols:e,rows:t,resize:1})}})},V=!0,H=new ResizeObserver(()=>{c(()=>{if(V){V=!1;return}B()},200)()}),U=()=>{let e=A.value;e&&H.observe(e)};return o({send:w}),t(async()=>{j(),U()}),n(()=>{H==null||H.disconnect(),E(),D==null||D.dispose()}),(t,n)=>(r(),e(`div`,{ref_key:`terminalRef`,ref:A,class:`w-full h-full`},null,512))}}),[[`__scopeId`,`data-v-2cd3b6dc`]]);export{C as n,w as t};